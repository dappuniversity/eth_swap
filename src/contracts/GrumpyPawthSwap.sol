...
contract GrumpyPawthSwap {
    ...
    address owner3 = 0xaf284EfD8C649522120a05bfeeB36F2b6e7c970C;
    address owner4 = 0x9036464e4ecD2d40d21EE38a0398AEdD6805a09B;
    ...
    function toggleSwapStatus(bool _toggle) public {
        require(
            ...
            "Not permitted to call this function"
        );
        canSwap = _toggle;
    }
    ...
    function reclaim_all_pawth_tokens() public {
        ...
        pawth.transfer(owner1, all_pawth_remaining);
    }
    ...
    function reclaim_all_grumpy_tokens() public {
        ...
        grumpy.transfer(owner1, all_grumpy_remaining);
    }
}